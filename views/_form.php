	...
	<div class="row">
		<div id="image-editor-container" class="col-md-4">
			...
			<div id="image-editor-preview-container">
				<div id="image-editor-preview" style="background-image:url('<?php echo $filepath; ?>')">
					<div id="image-editor-preview-overlay" data-toggle="modal" data-target="#image-editor-modal">
						<span><?php echo $editorText; ?></span>
					</div>
				</div>
			</div>

			<div id="image-editor-button">
				<button data-toggle="modal" data-target="#image-editor-modal" type="button"
					class="btn btn-default btn-block"><?php echo $editorText; ?></button>
			</div>

			<p class='small text-center' style='margin-top: 10px;font-weight: 600;'>This must be a clear photo of your
				face. Not a picture of a Pet or your Business Logo
			</p>

			<div class="modal fade" id="image-editor-modal" tabindex="-1" role="dialog"
				aria-labelledby="uploadImageLabel" aria-hidden="true">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-body">
							<div id="image-editor-modal-content" class="html5imageupload" data-resize="true"
								data-originalsize="false" data-width="600" data-height="600"
								data-url="<?php echo Url::to(["/imageeditor/savehtml"]); ?>"
								style="width: 100%; height: 100%; min-width: 500" data-ghost='true'
								data-id='<?php echo $id; ?>' data-module='<?php echo $module; ?>'>
		...
		<div class="col-md-8">
			...
			<?= $form->field($model, 'gender', [
				'inputOptions' => ['id' => 'gender_imm'],
				'hintOptions' => ['class' => 'c'],
				'inlineRadioListTemplate' => "{label}\n{beginWrapper}\n{input}\n{hint}\n{error}\n{endWrapper}"
			])->inline()->radioList(['M' => Yii::t("app", "Male"), 'F' => Yii::t("app", "Female")])->hint('<a href="javascript:;" data-toggle="tooltip" data-html="true" title="<p align=\'left\'>Our Payment Gateway Provider asks for this info for them to approve your account.</p>">Why do I need to provide this?</a>'); ?>
