        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="prof_app_text">
                    <h1>Enjoy Dog Grooming with PetCloud!</h1>
                    <p>PetCloud gives Dog Groomers the freedom to build a recurring client base, and live the flexible life you deserve.</p>
            ...
            <div class="col-md-6 col-sm-6">
                <div class="prof_app_img">
                    <img src="/img/pages/become-a-pet-sitter/dog-groomer.png" class="img-responsive"/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
				<div class="sitter_new_content new_layout_sitter">
					<h3><strong>PetCloud is looking for fear-free, experienced Dog Groomers who have at least 12 months experience in grooming and clipping across all breeds of dogs! Certification of Training is also required.</strong></h3>
					<p class="pink-heading">Need Training in Dog Grooming?  Head to our Partner <a href="https://www.igroomhub.com.au/" target="_black">[here]</a>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="panel-group" id="faqAccordion">
						...
						<div class="panel panel-default"  itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" >
							...
							<div id="collapseOne" class="panel-collapse collapse in" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" >
								<div class="panel-body" itemprop="text" >
									<p>Dog Groomers provide a number of services for dogs by washing, cutting, grooming and styling their coats, in addition to cleaning and clipping dogs' nails and detangling their fur.</p>
									<p><strong>Tasks and duties</strong></p>
									<ul>
										<li>Handling Bookings.</li>
										<li>Maintaining breed, clip and brand/product knowledge.</li>
										<li>Providing care for the pets whilst in your care.</li>
										<li>Maintaining a high standard of cleanliness</li>
										<li>Cleaning and maintenance of grooming room and equipment</li>
										<li>Maintaining safe and positive animal handling</li>
										<li>Bathing, washing, de-matting and drying dogs of varying breeds and coat types.</li>
										<li>Clipping nails, detangling coats and cleaning teeth by selecting and using appropriate grooming equipment.</li>
									</ul>
									<p>Dog grooming can be a physically demanding job, so it’s important that Groomers are able to spend long periods standing or crouching, and that they are calm and comfortable working with, and handling, different breeds of dog. Many Dog Groomers work from home, in pet salons, mobile dog vans, in veterinary practices or in kennels.</p>
								</div>
							</div>
						</div>
							...
							<div class="panel-heading">
								<h4 class="panel-title" itemprop="name" >
									<a class="accordion-toggle" data-toggle="collapse" data-parent="#faqAccordion" href="#collapseTwo">
										...
										Got 12 months salon grooming experience under your belt, and have achieved recognised Grooming Certification?
									</a>
								</h4>
							</div>
						...
						<div class="panel panel-default"  itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" >
							...
							<div id="collapse4" class="panel-collapse collapse" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" >
								<div class="panel-body" itemprop="text" >
									<p>The average hourly pay for a Dog Groomer in Australia is reported to be AU$22.21 but with PetCloud, you can make around $50-$60 per groom being a fear free dog groomer.</p>
								</div>
							</div>
						</div>
							...
							<div class="panel-heading">
								<h4 class="panel-title" itemprop="name" >
									<a class="accordion-toggle" data-toggle="collapse" data-parent="#faqAccordion" href="#collapse5">
										<span class="glyphicon glyphicon-plus-sign"></span>
										What are other ways to Make Money as a Dog Groomer?
									</a>
								</h4>
							</div>
							<div id="collapse5" class="panel-collapse collapse" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" >
								<div class="panel-body" itemprop="text" >
									...
									<ol>
										...
										<li>Poo Patrol and deodorizing patios and balconies, Cleaning Litter boxes, Fish Tank Cleaning</li>
										<li>Doggy Day Care & Puppy Desensitisation Period</li>
										<li>Health check-ups, desexing, teeth descales, vaccination boosters</li>
										<li>Grooming & Clipping Coats, Nail clips, Expressing Anal Glands, Cleaning ears and eyes, Washing and Brushing, Double Coat deshed and blow out.</li>
						...
						<div class="panel panel-default"  itemscope itemprop="mainEntity" itemtype="https://schema.org/Question" >
							<div class="panel-heading">
								<h4 class="panel-title" itemprop="name" >
									<a class="accordion-toggle" data-toggle="collapse" data-parent="#faqAccordion" href="#collapse7">
										<span class="glyphicon glyphicon-plus-sign"></span>
										How does PetCloud Work for Dog Groomers?
									</a>
								</h4>
							</div>
							<div id="collapse7" class="panel-collapse collapse" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" >
								<div class="panel-body" itemprop="text" >
									...
									<p><strong>Step 2. Get Verified &amp; Trained</strong><br>All applicants must upload a recent National Australian Police check received in the last 12 months or apply to undergo a new check. Take the Fear Free Grooming Course</p>
                        ...
                        <div class="row testimonials_row">
                            ...
                            <div class="col-md-9  col-sm-8">
                                <div class="profl_testi_contet">
                                    ...
                                    <p>- Cecilia, Dog Groomer in Caloundra</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <br> 
					<p class="heading_sitter"><strong>How do PetCloud Dog Groomers Make an Impact?</strong></p>	
					<p>Our Dog Groomers are an extremely important part of our community. Read about the <a href="https://www.petcloud.com.au/social-impact">social impact</a>you are helping to make.</p>
                </div>
            </div>
        </div>
    </div>
