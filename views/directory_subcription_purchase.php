												...
												<div class="row">
													<?php if ($product->name == "Pet Sitting Course") { ?>
														<div class="col-sm-3 col-md-3">
															<div class="img_purchase"><img
																	src="/img/pages/home-page/Weekly Dog Walking.png"
																	class="img-responsive lazy-load"></div>
														</div>
														<div class="col-sm-9 col-md-9">
															<div class="purchase_box_text">
																<h3><?= $product->name; ?></h3>
																<p>Do you dream of working with animals? Then being a pet
																	sitter/dog walker might be the answer! Get your confidence
																	up and understand the standard of care the RSPCA expects and
																	how to handle potentially tricky situations</p>
													...
													<div class="panel-group" id="accordion">
														...
														<div class="card_pay_form text-center">
															<button data-id="<?= $product->id; ?>"
																data-uom="<?= $product->Uom; ?>" class="btn primary"
																id="pay-with-wallet">Purchase</button>
														</div>
													</div>
												</div>
											</div>
					...
					<div id="exist_email">
						<?php if ($showExtra == "none") { ?>
							<div class='alert alert-danger'>
								<p>A profile already exists with this email, please check if it's your email address. Is it your
									email? Please click on <a id='change_pass_model' data-toggle='modal'
										data-target='#change_password'> Enter your password </a>or <a id='reset_email'>Reset
										your password</a>.Don't worry, you can still change the email address in the box below;
								</p>
							</div>
						<?php } ?>
					</div>
